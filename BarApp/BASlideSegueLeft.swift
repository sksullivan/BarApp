...
class BASlideSegueLeft: UIStoryboardSegue {
    override func perform() {
        ...
        dVC.view.frame = CGRectMake(sourceFrame.maxX, sourceFrame.minY, sourceFrame.width, sourceFrame.height)
        let destFrame = CGRectMake(sourceFrame.minX-sourceFrame.width, sourceFrame.minY, sourceFrame.width, sourceFrame.height)
